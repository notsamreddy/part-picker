...
const parts = [
  {
    ...
    quantity: 45,
    specs: "Fits all models, Replace every 15,000 miles",
  },
  {
    id: "2",
    name: "Brake Pads",
    price: 45.99,
    description: "Front brake pads for reliable stopping",
    quantity: 32,
    specs: "Ceramic compound, 50,000 mile warranty",
  },
  {
    id: "3",
    name: "Oil Filter",
    price: 8.99,
    description: "Oil filter for engine protection",
    quantity: 78,
    specs: "High-flow design, Compatible with synthetic oil",
  },
  {
    id: "4",
    name: "Spark Plugs",
    ...
    quantity: 120,
    specs: "Iridium tips, Pre-gapped to 0.044 inches",
  },
  {
    id: "5",
    name: "Wiper Blades",
    ...
    quantity: 54,
    specs: "Beam-style design, All-weather silicone",
  },
];
...
export const getPart = query({
  ...
  handler: async (_ctx, _args) => {
    return parts.find((part) => part.id === _args.partId) || null;
  },
});
